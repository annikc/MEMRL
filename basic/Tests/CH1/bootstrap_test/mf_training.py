...
memtemp = 0.05
memory = None # Memory.EpisodicMemory(cache_limit=400, entry_size=env.action_space.n, mem_temp=memtemp)
...
run.record_log(file='MFtraining.csv',
               expt_type=f'mf_ec_t{memtemp}',
               env_name=env_name,
               n_trials=ntrials, n_steps=nevents)
