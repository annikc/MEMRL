...
write_to_file = 'train_test_CONVperceptronAC.csv'
...
AC_head_agent = nets.flat_ActorCritic(400, output_dims=env.action_space.n, lr=learning_rate)
top_layer_dict = {}
...
test_run.record_log(env_name, representation_name,num_trials*3,num_events,dir=directory, file=write_to_file,mock_log=True)