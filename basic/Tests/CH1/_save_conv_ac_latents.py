...
example_run_ids = ['990b45e3-49a6-49e0-8b85-e1dbbd865504',
...
convert_agent_to_weight_dict(f'../../Data/network_objs/{run_id}.pt',
                             destination_path=f'./../../Data/agents/{run_id}.pt')
