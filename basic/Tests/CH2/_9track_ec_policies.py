...
from modules.Experiments import flat_ec_pol_track as flat_expt
sys.path.append('../../../')
import argparse
...
ex.run(num_trials,num_events,snapshot_logging=False,printfreq=10)
