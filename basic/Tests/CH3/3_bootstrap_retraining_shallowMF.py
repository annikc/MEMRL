...
print(args)
write_to_file = 'bootstrapped_retrain_shallow_AC.csv'
...
run.record_log(env_name, representation_name,num_trials,num_events,dir=directory, file=write_to_file, load_from=load_from, extra_info='occ_map')
