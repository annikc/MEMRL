...
parent_path = '../../Data/'
df = pd.read_csv(parent_path+'conv_mf_bootstrap.csv')
...
base_ = pd.read_csv(parent_path+'conv_mf_retraining.csv')
...
id_list = gb.get_group((env[0:22],rep,int(cache_limits[env][100]*(pct/100))))
print(id_list)
...
plot_compare_conv_retraining(envs_to_plot,[100,75,50,25])