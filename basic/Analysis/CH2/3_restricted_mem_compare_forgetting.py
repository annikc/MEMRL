...
from Analysis.analysis_utils import avg_performance_over_envs, compare_perf_over_envs_violins_sidebyside
...
compare_perf_over_envs_violins_sidebyside(gb,rf_gb,envs_to_plot,reps_to_plot,pcts_to_plot,grids,colors=color_map,labels=labels,legend='pcts',compare_chance=True,savename=f'compare_rf_{split_type}_violins_sidebyside',save=True)