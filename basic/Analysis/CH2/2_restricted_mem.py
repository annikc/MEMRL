...
if split_type == 'SU':
    ...
    reps_to_plot = ['structured']#['unstructured','structured']
...
#avg_perf_over_envs_lines(gb,envs_to_plot,reps_to_plot,pcts_to_plot,grids,colors=color_map,labels=labels,legend='reps',savename=f'restricted_{split_type}_lines',compare_chance=True,save=True)
avg_performance_over_envs_violins(gb,envs_to_plot,reps_to_plot,pcts_to_plot,grids,colors=color_map,labels=labels,legend='reps',savename=f'restricted_{split_type}_violins_inset',compare_chance=True,save=True)
