...
from modules.Agents.RepresentationLearning.learned_representations import saved_latents
...
state_reps, representation_name, input_dims, _ = saved_latents(train_env,type=latent_type)
print(state_reps[0])
...
print('init weight',empty_net.pol.weight)
AC_head_agent = load_saved_head_weights(empty_net, agent_path)
print('load weight',AC_head_agent.pol.weight)
print(AC_head_agent)
