...
###		Environment > TrialSet > Trial > State
class State(object):
	'''
...
class Environment(object):
	...
	Default environment is T-maze with two states in each direction 
	'''
...
### Define Functions Used In Objects
...
#------------------------------------------------------
"""		 Trial Run Visualiztation Functions 		"""
#------------------------------------------------------
